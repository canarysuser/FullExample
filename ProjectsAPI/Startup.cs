...
namespace ProjectsAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<ProjectsDataAccess.ProjectsDbContext>(options =>
            {
                options.UseSqlServer(
                    connectionString: "server=(local);database=ProjectTestDb;TrustServerCertificate=true;integrated security=sspi");
            });
